...
class PostServices:
    ...
    @classmethod
    async def edit_post(cls, post: SPost, post_id: int, user_id: int, file: UploadFile = None):
        ...
        image_url = existing_post.image_url  # сохраняем старое изображение по умолчанию
        if file and file.filename:
